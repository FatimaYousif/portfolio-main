...
function ProjectCard({
    ...
    return (
        <RevealContent
            style={`flex flex-col md:flex-row ${
        ...
        >
            <>
                ...
                <div className="bg-[#EFF6FF] dark:bg-[#08203E] rounded-[10px] p-11 flex flex-col gap-6 w-full md:w-7/12 shadow-lightCard dark:shadow-darkCard">
