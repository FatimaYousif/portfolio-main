...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    imagePosition: "right",
    githubLink: "https://github.com/FatimaYousif/td3_ros2_navigation",
  },

   {
    ...
    categories: ["Perception", "Robotics"],
    technologies: [],
  ...
  },
  {
    ...
    categories: ["Localization", "Robotics"],
    technologies: [],
    imageSrc: "/images/hol_hop.png",
    imagePosition: "right",
...

  {
    ...
    categories: ["Perception", "Localization"],
    technologies: [],
  ...
  {
    name: "Modeling and Control of Quadrotors",
    description:
...

  {
    ...
    categories: ["Manipulation", "Robotics"],
    technologies: [],
  ...
  // },
  {
    ...
    categories: ["Manipulation", "Planning", "Robotics"],
    technologies: [],
  ...
  },
  {
    ...
    categories: ["Reinforcement Learning", "Planning"],
    technologies: [],
